...
import messages as singleMessage
...
class AboutMDQCGUI(GUILibraries.QDialog):
    ...
    def SetDesgin(self):
        ...
        pic.setPixmap(GUILibraries.QPixmap(self.configuration.getLogoSignSmall()))
        ...
        if OS_Info == 'Windows':
            ...
            self.contet.setFixedSize(500,500)
    ...
    def Cancel(self):
        ...
        self.parent_win.setWindowTitle(self.configuration.application_name+" "+self.configuration.getApplicationVersion())
        self.destroy()
        self.close()
